...
class ImageTool {
  ...
  constructor({ data, config, api, readOnly }) {
    ...
    // Debug logging
    console.log('ImageTool constructor data:', data);
    ...
    console.log('ImageTool processed data:', this.data);
  ...
  render() {
    ...
    container.classList.add('image-tool-container');

    const uploadButton = document.createElement('button');
    uploadButton.type = 'button';
    uploadButton.classList.add('image-tool-upload');
  ...
  _showImageSelector() {
    // En lugar de mostrar el modal aquí, vamos a emitir un evento personalizado
    // que será capturado por el componente PostEditor de React
  ...
  _acceptTuneView() {
    this.settings.forEach(tune => {
      ...
      el.classList.toggle(`image-tool--${tune.name}`, this.data[tune.name]);
